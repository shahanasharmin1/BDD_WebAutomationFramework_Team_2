...
public class HomePage extends WebAPI {
    ...
    public void getSearchZip(){ findSearchZip.sendKeys("11373"); }
    public void getsearchStartQuote(){ findsearchStartQuote.click(); }
    public void getSearchAuto(){findSearchAuto.click();}
    public void getSearchRenters(){findSearchRenters.click();}
    public void getSearchForHome(){findSearchForHome.click();}
    public void getSearchForCondo(){findSearchForCondo.click();}
