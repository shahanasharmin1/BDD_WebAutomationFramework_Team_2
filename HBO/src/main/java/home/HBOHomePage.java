...
public class HBOHomePage extends WebAPI {
    ...
    @FindBy(how = How.XPATH, using = freeEpisodeWebElement) public WebElement freeEpisode;
    @FindBy(how = How.XPATH, using = privacyPolicyWebElement) public WebElement privacyPolicy;
    ...
    public void validateDocPage(){
        ...
        Assert.assertEquals("https://www.hbo.com/documentaries",actualTitle);
    }
    ...
    public void validateAllSeriesPage(){
        String actualTitle=driver.getCurrentUrl();
        Assert.assertEquals("https://www.hbo.com/series/all-series",actualTitle);
    }
    ...
    public void validateAllSpecialsPage(){
        String actualTitle=driver.getCurrentUrl();
        Assert.assertEquals("https://www.hbo.com/specials/all-specials",actualTitle);
    }
    ...
    public void validateKidsPage(){
        String actualTitle=driver.getCurrentUrl();
        Assert.assertEquals("https://www.hbo.com/kids/esme-and-roy",actualTitle);
    }
    ...
    public void validateSportsPage(){
        String actualTitle=driver.getCurrentUrl();
        Assert.assertEquals("https://www.hbo.com/sports/sports-catalog",actualTitle);
    }
    ...
    public void validateAboutTab(){
      ...
      public void validateUrl(){
        String actualTitle=driver.getCurrentUrl();
        Assert.assertEquals("https://www.hbo.com/about/",actualTitle);
    }
    public void checkFB(){
       facebookTab();
   ...
   public void selectFreeEpisode(){freeEpisode.click();}

    public void validateFreeEpisode(){
        String actualTitle=driver.getCurrentUrl();
        Assert.assertEquals("https://www.hbo.com/watch-free-episodes",actualTitle);
    }

    public void selectPrivacyPolicy(){privacyPolicy.click();}

    public void validatePrivacyPolicy(){
        String actualTitle=driver.getCurrentUrl();
        Assert.assertEquals("https://www.hbo.com/privacy-policy",actualTitle);
    }
